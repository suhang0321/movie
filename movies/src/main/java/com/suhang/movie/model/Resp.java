...
public class Resp implements Serializable {
    ...
    public static final Resp UNAUTHENTICATED = Resp.from(RespCode.UNAUTHENTICATED);
    public static final Resp UNAUTHORIZED = Resp.from(RespCode.UNAUTHORIZED);
